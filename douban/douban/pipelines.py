...
#     def __init__(self):
#         self.dbpool = adbapi.ConnectionPool("MySQLdb", db = "douban", user = "root",
#             passwd = "root", charset = "utf8", use_unicode = False,
#             host='127.0.0.1', cursorclass = cursors.DictCursor,
#             )
...
#             self.dbpool.runInteraction(self.do_replace, item)
