...
class RakutenMovieMySQLPipeline:
    '''存在则更新，不存在插入数据库'''
...
class RakutenMovieTop250MySQLPipeline:
    '''豆瓣Top250一次性写入Mysql表'''
...
class RakutenSubjectMongoPipeline:
